	...
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/tenant_user/table" v-show="user_group == '管理员' || $check_action('/tenant_user/table')"><span>租客用户</span></el-menu-item>
							<el-menu-item index="/homeowner_user/table" v-show="user_group == '管理员' || $check_action('/homeowner_user/table')"><span>房主用户</span></el-menu-item>
