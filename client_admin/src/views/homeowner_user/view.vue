		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="房主姓名" prop="name_of_the_owner">
												<el-input id="name_of_the_owner" v-model="form_sub['name_of_the_owner']" placeholder="请输入房主姓名"
							  v-if="user_group === '管理员' || (form_sub['homeowner_user_id'] && $check_field('set','name_of_the_owner')) || (!form_sub['homeowner_user_id'] && $check_field('add','name_of_the_owner'))"></el-input>
					<div v-else-if="$check_field('get','name_of_the_owner')">{{form_sub['name_of_the_owner']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="性别" prop="gender">
						...
						v-if="user_group === '管理员' || (form_sub['homeowner_user_id'] && $check_field('set','gender')) || (!form_sub['homeowner_user_id'] && $check_field('add','gender'))">
