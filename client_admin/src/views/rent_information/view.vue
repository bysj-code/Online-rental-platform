	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="房屋编号" prop="house_no">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','house_no')) || (!form['rent_information_id'] && $check_field('add','house_no'))" :disabled="disabledObj['house_no_isDisabled']"></el-input>
				...
				<el-form-item label="房屋名称" prop="house_name">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','house_name')) || (!form['rent_information_id'] && $check_field('add','house_name'))" :disabled="disabledObj['house_name_isDisabled']"></el-input>
				...
				<el-form-item label="房屋类型" prop="house_type">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','house_type')) || (!form['rent_information_id'] && $check_field('add','house_type'))" :disabled="disabledObj['house_type_isDisabled']"></el-input>
				...
				<el-form-item label="厅室" prop="hall">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','hall')) || (!form['rent_information_id'] && $check_field('add','hall'))" :disabled="disabledObj['hall_isDisabled']"></el-input>
				...
				<el-form-item label="详细地址" prop="detailed_address">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','detailed_address')) || (!form['rent_information_id'] && $check_field('add','detailed_address'))" :disabled="disabledObj['detailed_address_isDisabled']"></el-input>
				...
				<el-form-item label="房主用户" prop="homeowner_user">
													<el-select v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','homeowner_user')) || (!form['rent_information_id'] && $check_field('add','homeowner_user'))" id="homeowner_user" v-model="form['homeowner_user']" :disabled="disabledObj['homeowner_user_isDisabled']">
				...
				<el-form-item label="房主姓名" prop="name_of_the_owner">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','name_of_the_owner')) || (!form['rent_information_id'] && $check_field('add','name_of_the_owner'))" :disabled="disabledObj['name_of_the_owner_isDisabled']"></el-input>
				...
				<el-form-item label="租客用户" prop="tenant_user">
													<el-select v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','tenant_user')) || (!form['rent_information_id'] && $check_field('add','tenant_user'))" id="tenant_user" v-model="form['tenant_user']" :disabled="disabledObj['tenant_user_isDisabled']">
				...
				<el-form-item label="租金" prop="rent">
						...
						v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','rent')) || (!form['rent_information_id'] && $check_field('add','rent'))" :disabled="disabledObj['rent_isDisabled']"></el-input-number>
					<div v-else-if="$check_field('get','rent')">{{form['rent']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','rent_collection_date') || $check_field('add','rent_collection_date') || $check_field('set','rent_collection_date')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="收租日期" prop="rent_collection_date">
								<el-date-picker :disabled="disabledObj['rent_collection_date_isDisabled']" v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','rent_collection_date')) || (!form['rent_information_id'] && $check_field('add','rent_collection_date'))" id="rent_collection_date"
						v-model="form['rent_collection_date']" type="date" placeholder="选择日期">
					</el-date-picker>
					<div v-else-if="$check_field('get','rent_collection_date')">{{form['rent_collection_date']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="备注" prop="remarks">
							  ...
							  v-if="user_group === '管理员' || (form['rent_information_id'] && $check_field('set','remarks')) || (!form['rent_information_id'] && $check_field('add','remarks'))" :disabled="disabledObj['remarks_isDisabled']"></el-input>
		...
		methods: {
						...
						Object.keys(form).forEach(dbKey => {
							...
							if(key === dbKey){
								this.disabledObj[key+'_isDisabled'] = true;
																				        ...
																				        if (this.form["rent_collection_date"].indexOf("-")===-1){
          this.form["rent_collection_date"] = this.$toTime(parseInt(this.form["rent_collection_date"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																													        ...
																													        if(this.form["rent_collection_date"]=="0000-00-00"){
          this.form["rent_collection_date"] = null;
        }
				if(parseInt(this.form["rent_collection_date"]) > 9999){
					this.form["rent_collection_date"] = this.$toTime(parseInt(this.form["rent_collection_date"]),"yyyy-MM-dd")
				}
