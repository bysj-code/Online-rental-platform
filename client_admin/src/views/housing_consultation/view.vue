	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="房屋编号" prop="house_no">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','house_no')) || (!form['housing_consultation_id'] && $check_field('add','house_no'))" :disabled="disabledObj['house_no_isDisabled']"></el-input>
				...
				<el-form-item label="房屋名称" prop="house_name">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','house_name')) || (!form['housing_consultation_id'] && $check_field('add','house_name'))" :disabled="disabledObj['house_name_isDisabled']"></el-input>
				...
				<el-form-item label="房屋类型" prop="house_type">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','house_type')) || (!form['housing_consultation_id'] && $check_field('add','house_type'))" :disabled="disabledObj['house_type_isDisabled']"></el-input>
				...
				<el-form-item label="押金" prop="deposit">
						...
						v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','deposit')) || (!form['housing_consultation_id'] && $check_field('add','deposit'))" :disabled="disabledObj['deposit_isDisabled']"></el-input-number>
				...
				<el-form-item label="租金" prop="rent">
						...
						v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','rent')) || (!form['housing_consultation_id'] && $check_field('add','rent'))" :disabled="disabledObj['rent_isDisabled']"></el-input-number>
				...
				<el-form-item label="厅室" prop="hall">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','hall')) || (!form['housing_consultation_id'] && $check_field('add','hall'))" :disabled="disabledObj['hall_isDisabled']"></el-input>
				...
				<el-form-item label="详细地址" prop="detailed_address">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','detailed_address')) || (!form['housing_consultation_id'] && $check_field('add','detailed_address'))" :disabled="disabledObj['detailed_address_isDisabled']"></el-input>
				...
				<el-form-item label="房主用户" prop="homeowner_user">
													<el-select v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','homeowner_user')) || (!form['housing_consultation_id'] && $check_field('add','homeowner_user'))" id="homeowner_user" v-model="form['homeowner_user']" :disabled="disabledObj['homeowner_user_isDisabled']">
				...
				<el-form-item label="房主姓名" prop="name_of_the_owner">
							  ...
							  v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','name_of_the_owner')) || (!form['housing_consultation_id'] && $check_field('add','name_of_the_owner'))" :disabled="disabledObj['name_of_the_owner_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','name_of_the_owner')">{{form['name_of_the_owner']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','consultation_date') || $check_field('add','consultation_date') || $check_field('set','consultation_date')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询日期" prop="consultation_date">
								<el-date-picker :disabled="disabledObj['consultation_date_isDisabled']" v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','consultation_date')) || (!form['housing_consultation_id'] && $check_field('add','consultation_date'))" id="consultation_date"
						v-model="form['consultation_date']" type="date" placeholder="选择日期">
					</el-date-picker>
					<div v-else-if="$check_field('get','consultation_date')">{{form['consultation_date']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="租客用户" prop="tenant_user">
							...
							<!--v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','tenant_user')) || (!form['housing_consultation_id'] && $check_field('add','tenant_user'))" :disabled="disabledObj['tenant_user_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','tenant_user')">{{form['tenant_user']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','tenant_user')) || (!form['housing_consultation_id'] && $check_field('add','tenant_user'))" id="tenant_user" v-model="form['tenant_user']" :disabled="disabledObj['tenant_user_isDisabled']">
				...
				<el-form-item label="咨询内容" prop="consultation_content">
						...
						v-if="user_group === '管理员' || (form['housing_consultation_id'] && $check_field('set','consultation_content')) || (!form['housing_consultation_id'] && $check_field('add','consultation_content'))" :disabled="disabledObj['consultation_content_isDisabled']"></el-input>
		...
		methods: {
						...
						Object.keys(form).forEach(dbKey => {
							...
							if(key === dbKey){
								this.disabledObj[key+'_isDisabled'] = true;
																				        ...
																				        if (this.form["consultation_date"].indexOf("-")===-1){
          this.form["consultation_date"] = this.$toTime(parseInt(this.form["consultation_date"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																													        ...
																													        if(this.form["consultation_date"]=="0000-00-00"){
          this.form["consultation_date"] = null;
        }
				if(parseInt(this.form["consultation_date"]) > 9999){
					this.form["consultation_date"] = this.$toTime(parseInt(this.form["consultation_date"]),"yyyy-MM-dd")
				}
