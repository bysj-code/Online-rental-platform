			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="状态" prop="state">
					<el-select v-model="form.state" placeholder="请选择">
						...
						<el-col v-if="user_group === '管理员' || $check_field('get','tenant_name') || $check_field('add','tenant_name') || $check_field('set','tenant_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="租客姓名" prop="tenant_name">
												<el-input id="tenant_name" v-model="form_sub['tenant_name']" placeholder="请输入租客姓名"
							  v-if="user_group === '管理员' || (form_sub['tenant_user_id'] && $check_field('set','tenant_name')) || (!form_sub['tenant_user_id'] && $check_field('add','tenant_name'))"></el-input>
					<div v-else-if="$check_field('get','tenant_name')">{{form_sub['tenant_name']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="性别" prop="gender">
						...
						v-if="user_group === '管理员' || (form_sub['tenant_user_id'] && $check_field('set','gender')) || (!form_sub['tenant_user_id'] && $check_field('add','gender'))">
