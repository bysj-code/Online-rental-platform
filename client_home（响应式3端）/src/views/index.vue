		...
		<div class="warp">
		    <div class="container">
		        <div class="row">
					...
					<!-- 推荐房源信息模块(开始) -->
		<div class="warp" v-if="$check_action('/housing_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
		                    ...
		                    <div class="more_box">
		                        <router-link to="/housing_information/list" class="more">
		                            <span>更多</span>
		                        </router-link>
		                    </div>
		                    <div class="switch" @click="show_list_housing_information = !show_list_housing_information">
		                        <div class="switch_box">
		                            <span v-if="show_list_housing_information"> 切换表格 </span>
		                            <span v-else> 切换列表 </span>
		                        </div>
		                    </div>
		                </div>
		                <!-- 房源信息推荐列表组件 -->
		                <list_housing_information v-if="show_list_housing_information" :list="list_housing_information" />
		                <div class="overflow-auto" v-else>
		                    <table id="list_diy" role="table" aria-busy="false"
		                           :aria-colcount="fields_housing_information.length"
		                           class="table b-table table-striped table-hover">
		                        <thead>
		                        <tr>
		                            <th v-for="(o,i) in fields_housing_information" :key="i">
		                                {{o.label}}
		                            </th>
		                        </tr>
		                        </thead>
		                        <tbody>
		                        <tr v-for="(o, i) in list_table_housing_information" :key="i" @click="to_details('housing_information',o,'housing_information_id')">
		                            <td v-for="(oj,n) in fields_housing_information">
		                                <img v-if="oj.type && oj.type == '图片' " :src="$fullUrl(o[oj.key])" alt=""
		                                     v-default-img="'/img/default.png'">
		...
		data() {
			return {
				...
				show_list_article: true,
							show_list_housing_information: true,
				list_housing_information: [],
				vm_arr_housing_information: [
