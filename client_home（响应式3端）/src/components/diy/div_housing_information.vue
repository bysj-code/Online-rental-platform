			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/housing_consultation/edit','add')" @click="to_form('/housing_consultation/edit')" > 咨询 </button>
										<button class="btn btn-primary details_btn" v-if="$check_action('/lease_application/edit','add')" @click="to_form('/lease_application/edit')" > 申请租赁 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/housing_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/housing_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
