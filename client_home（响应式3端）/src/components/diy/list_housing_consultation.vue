<template>
	<div class="diy_home diy_list diy_housing_consultation" id="diy_housing_consultation_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/housing_consultation/details?housing_consultation_id=' + o['housing_consultation_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/housing_consultation/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/housing_consultation/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						房主姓名
							...
							<th class="diy_title" v-if="$check_field('get','consultation_date')">
						咨询日期
					</th>
							<th class="diy_title" v-if="$check_field('get','tenant_user')">
						租客用户
					</th>
							<th class="diy_title" v-if="$check_field('get','consultation_content')">
						咨询内容
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','consultation_date')">
						<span>
