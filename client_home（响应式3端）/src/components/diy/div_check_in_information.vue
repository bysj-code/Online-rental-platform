			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/rent_information/edit','add')" @click="to_form('/rent_information/edit')" > 房租信息 </button>
										<button class="btn btn-primary details_btn" v-if="$check_action('/feedback_information/edit','add')" @click="to_form('/feedback_information/edit')" > 反馈信息 </button>
										<button class="btn btn-primary details_btn" v-if="$check_action('/notification_information/edit','add')" @click="to_form('/notification_information/edit')" > 通知信息 </button>
										</div>
						<!-- 富文本 -->
