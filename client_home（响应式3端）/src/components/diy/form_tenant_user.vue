<template>
	<div>
			<b-form-group v-if="$check_register_field('add','tenant_name','/tenant_user/view')" id="input-group-${idx}" label="租客姓名" label-for="input-${idx}">
			<b-form-input id="input-${idx}" v-model="form['tenant_name']" type="text" placeholder="租客姓名" trim></b-form-input>
		</b-form-group>
