<template>
	<div class="diy_home diy_list diy_notification_information" id="diy_notification_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/notification_information/details?notification_information_id=' + o['notification_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/notification_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/notification_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						详细地址
							...
							<th class="diy_title" v-if="$check_field('get','homeowner_user')">
						房主用户
					</th>
							<th class="diy_title" v-if="$check_field('get','name_of_the_owner')">
						房主姓名
					</th>
							<th class="diy_title" v-if="$check_field('get','tenant_user')">
						租客用户
					</th>
							<th class="diy_title" v-if="$check_field('get','notification_date')">
						通知日期
					</th>
							<th class="diy_title" v-if="$check_field('get','notification_content')">
						通知内容
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_uid" v-if="$check_field('get','homeowner_user')">
						<span>
							{{ get_user_name(o['homeowner_user']) }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','name_of_the_owner')">
						<span>
							{{ o["name_of_the_owner"] }}
						</span>
					</td>
						...
						<span>
							{{ get_user_name(o['tenant_user']) }}
						</span>
					</td>
							<td class="diy_field diy_date" v-if="$check_field('get','notification_date')">
						<span>
							{{ $toTime(o["notification_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','notification_content')">
						<span>
