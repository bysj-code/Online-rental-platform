<template>
	<view class="diy_details diy_div_feedback_information">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/feedback_information/get_obj", {
					feedback_information_id:this.query.feedback_information_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["feedback_information_id"] !==0) {
...
<style scoped>
	.div_feedback_information_details {}
