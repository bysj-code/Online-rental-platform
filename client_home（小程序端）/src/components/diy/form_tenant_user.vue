<template>
	<div>
			<view v-if="$check_register_field('add','tenant_name','/tenant_user/view')" class="col-12 col-md-6">
			<view class="diy_title">
				...
				<view class="diy_field diy_text">
					<input type="text" id="form_tenant_name" v-model="form['tenant_name']" @blur="handleBlur($event.target.value,'tenant_name')"  placeholder="请输入租客姓名" />
				</view>
							</view>
				<view v-if="$check_register_field('add','gender','/tenant_user/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					性别:
				</text>
