<template>
  <view class="page_house_type diy_table diy_table_tml" id="house_type_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="房屋类型" name="house_type">
                      <uni-easyinput type="text" v-model="query.house_type" placeholder="房屋类型" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/house_type/view?" v-show="user_group == '管理员' || $check_action('/house_type/table','add') || $check_action('/house_type/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','house_type')" class="col">
						<view class="view">
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/house_type/table','del') || $check_action('/house_type/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/house_type/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/house_type/table','set') || $check_action('/house_type/view','set') || $check_action('/house_type/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
