          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','house_no') || $check_field('add','house_no') || $check_field('set','house_no')" label="房屋编号" name="house_no">
                                <uni-easyinput type="text" v-model="form['house_no']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','house_no')) || (!form['feedback_information_id'] && $check_field('add','house_no'))" :disabled="disabledObj['house_no_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','house_name') || $check_field('add','house_name') || $check_field('set','house_name')" label="房屋名称" name="house_name">
                                <uni-easyinput type="text" v-model="form['house_name']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','house_name')) || (!form['feedback_information_id'] && $check_field('add','house_name'))" :disabled="disabledObj['house_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','house_type') || $check_field('add','house_type') || $check_field('set','house_type')" label="房屋类型" name="house_type">
                                <uni-easyinput type="text" v-model="form['house_type']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','house_type')) || (!form['feedback_information_id'] && $check_field('add','house_type'))" :disabled="disabledObj['house_type_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','rent') || $check_field('add','rent') || $check_field('set','rent')" label="租金" name="rent">
                                <uni-easyinput type="text" v-model="form['rent']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','rent')) || (!form['feedback_information_id'] && $check_field('add','rent'))" :disabled="disabledObj['rent_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','hall') || $check_field('add','hall') || $check_field('set','hall')" label="厅室" name="hall">
                                <uni-easyinput type="text" v-model="form['hall']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','hall')) || (!form['feedback_information_id'] && $check_field('add','hall'))" :disabled="disabledObj['hall_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','detailed_address') || $check_field('add','detailed_address') || $check_field('set','detailed_address')" label="详细地址" name="detailed_address">
                                <uni-easyinput type="text" v-model="form['detailed_address']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','detailed_address')) || (!form['feedback_information_id'] && $check_field('add','detailed_address'))" :disabled="disabledObj['detailed_address_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','homeowner_user') || $check_field('add','homeowner_user') || $check_field('set','homeowner_user')" label="房主用户" name="homeowner_user">
                  ...
                  v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','homeowner_user')) || (!form['feedback_information_id'] && $check_field('add','homeowner_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['homeowner_user']"
                  :localdata="list_user_homeowner_user"
              ...
              <uni-forms-item v-if="$check_field('get','name_of_the_owner') || $check_field('add','name_of_the_owner') || $check_field('set','name_of_the_owner')" label="房主姓名" name="name_of_the_owner">
                                <uni-easyinput type="text" v-model="form['name_of_the_owner']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','name_of_the_owner')) || (!form['feedback_information_id'] && $check_field('add','name_of_the_owner'))" :disabled="disabledObj['name_of_the_owner_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','tenant_user') || $check_field('add','tenant_user') || $check_field('set','tenant_user')" label="租客用户" name="tenant_user">
                  ...
                  v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','tenant_user')) || (!form['feedback_information_id'] && $check_field('add','tenant_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['tenant_user']"
                  :localdata="list_user_tenant_user"
              ...
              <uni-forms-item v-if="$check_field('get','feedback_date') || $check_field('add','feedback_date') || $check_field('set','feedback_date')" label="反馈日期" name="feedback_date">
                        <uni-datetime-picker v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','feedback_date')) || (!form['feedback_information_id'] && $check_field('add','feedback_date'))" v-model="form['feedback_date']" type="date" :disabled="disabledObj['feedback_date_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','feedback_content') || $check_field('add','feedback_content') || $check_field('set','feedback_content')" label="反馈内容" name="feedback_content">
                        <uni-easyinput type="textarea" v-model="form['feedback_content']" v-if="user_group === '管理员' || (form['feedback_information_id'] && $check_field('set','feedback_content')) || (!form['feedback_information_id'] && $check_field('add','feedback_content'))" :disabled="disabledObj['feedback_content_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_upload: "~/api/feedback_information/upload?",
  ...
  methods: {
    ...
    is_view(){
      ...
      if(!bl){
        bl = this.$check_action('/feedback_information/table','add');
        console.log(bl ? "你有表格添加权限视作有添加权限" : "你没有表格添加权限");
      }
      if(!bl){
        bl = this.$check_action('/feedback_information/table','set');
        console.log(bl ? "你有表格添加权限视作有修改权限" : "你没有表格修改权限");
      }
      if(!bl){
        bl = this.$check_action('/feedback_information/view','add');
        console.log(bl ? "你有视图添加权限视作有添加权限" : "你没有视图添加权限");
      }
      if(!bl){
        bl = this.$check_action('/feedback_information/view','set');
        console.log(bl ? "你有视图修改权限视作有修改权限" : "你没有视图修改权限");
      }
      if(!bl){
        bl = this.$check_action('/feedback_information/view','get');
