<template>
  <view class="page_housing_information diy_table diy_table_tml" id="housing_information_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/housing_information/view?" v-show="user_group == '管理员' || $check_action('/housing_information/table','add') || $check_action('/housing_information/view','add')">添加</navigator>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/housing_information/table','del') || $check_action('/housing_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/housing_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/housing_information/table','set') || $check_action('/housing_information/view','set') || $check_action('/housing_information/view','get')" class="btn btn-primary">详情</navigator>
																							<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/housing_consultation/view','add')" @click="to_form('/pages/housing_consultation/view',o)">
									<span>咨询</span>
								</a>
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/lease_application/view','add')" @click="to_form('/pages/lease_application/view',o)">
									<span>申请租赁</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                            // 房屋类型列表
                list_house_type: [{value:"",text:"全部"}],
                                            // 厅室列表
                list_hall: [{value:"",text:"全部"}],
                                                        // 用户列表
