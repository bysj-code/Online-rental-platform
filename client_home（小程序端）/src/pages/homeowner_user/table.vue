<template>
  <view class="page_homeowner_user diy_table diy_table_tml" id="homeowner_user_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="房主姓名" name="name_of_the_owner">
                      <uni-easyinput type="text" v-model="query.name_of_the_owner" placeholder="房主姓名" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/homeowner_user/view?" v-show="user_group == '管理员' || $check_action('/homeowner_user/table','add') || $check_action('/homeowner_user/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/homeowner_user/table','del') || $check_action('/homeowner_user/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/homeowner_user/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/homeowner_user/table','set') || $check_action('/homeowner_user/view','set') || $check_action('/homeowner_user/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
